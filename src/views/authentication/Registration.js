            ...
            <div className="leftSide">
                <div className="leftSide_container">
                    ...
                    {step === 1 && <StepContainer step={1} headerTitle="let us know you">
                        <Input text="text" handleChange={handleChange} icon={passwordIcon} label="firstName"
                               fieldError={fieldError}/>
                        <Input text="text" handleChange={handleChange} icon={passwordIcon} label="lastName"
                               fieldError={fieldError}/>
                        <Input text="text" handleChange={handleChange} icon={emailIcon} label="email"
                               fieldError={fieldError}/>
                    </StepContainer>}
                    ...
                    {step === 1 &&
                        <button onClick={() => setStep(2)} style={{width: '65%'}} className="authentication-button" >Next
                            Step</button>}

                    {step === 2 &&
                        <div onClick={() => setStep(1)} style={{display: "flex", justifyContent:"space-between"}}>
                            <button  style={{width: '45%'}} className="authentication-button-alternate"
                                    >Go Back
                            </button>
